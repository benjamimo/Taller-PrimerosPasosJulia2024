...
# ╔═╡ 52312d5e-90a5-11ed-2cfc-335dfb535e75
using PlutoUI,Images

# ╔═╡ 55372c8a-4d61-49ac-8788-ec8c9947e3f7
html"<button onclick='present()'>Presentación</button>"

# ╔═╡ ae7d1b8e-a3fc-4007-99b7-eb257f390cdb
md"""
# Programación en Julia:  Primeros pasos
${\Huge\text{\bf 3. Control de flujo}}$
...
# ╔═╡ b4fd0144-c2c4-4cb9-a030-24e99e8df259
md"""
## Condicionales
...
# ╔═╡ 9c23a5b0-ba56-4536-8df0-fd87f29c6b1f
md"###### Ejemplo 1: Condicional clásico"

# ╔═╡ 6d67a28e-01fd-41b7-85d4-d4a6b87df072
let
	var = 7;
	if var > 10
...
# ╔═╡ 9f42da56-4213-4b31-b52a-7555d0dcb02f
md"""
El condicional puede contener varios `elseif` o puede omitirse `else`.
"""

# ╔═╡ 1348b7d5-2bd7-49f4-997c-4b4c4e798f4e
md"""
...
# ╔═╡ 143ce345-7425-42b1-a634-cf50f0ddd5da
let
	a = 10;
	b = 15;
	z = a > b ? a : b
...
# ╔═╡ cae1fcee-1270-4389-b9bc-d247af37ebf8
md"###### Ejemplo 3: Operador ternario encadenado"

# ╔═╡ 7cfaa484-7119-4980-a3a9-4957dfac7f5e
let
	var = 7
...
# ╔═╡ f182b40e-b04a-4699-b424-eb8283ce47bd
md"""
...
# ╔═╡ 20048bd7-2b0f-49c4-8255-277e1d02aaa2
let
...
# ╔═╡ c8c34c84-48f5-4bac-8205-65ea79237b98
md"""
## Evaluación repetida
...
# ╔═╡ fcc2c0a0-c047-4e39-8a43-d2cac61b7091
md"""
### for loops
Forma general
...
# ╔═╡ 9e4518c4-dd58-4db1-bbbf-6bbe14b3be92
md"""
###### Ejemplo 1: for bucle
"""

# ╔═╡ dc546b19-4444-43e1-8773-5030cbb4cfe5
let 
	for n = 1:10
		println(n^3)
	end
...
# ╔═╡ ae49e095-1a57-47bb-9082-fea021b97a6b
md"###### Ejemplo 2: for bucle sobre elementos de arreglo"

# ╔═╡ 45e3cf3b-6f4a-4add-8f7c-7f455eeefaec
let
...
# ╔═╡ 11ed5f92-3270-4e0f-8e2f-1d5f9713c3fb
md"###### Ejemplo 3: Función enumerate"

# ╔═╡ 433fb271-08a6-4777-8096-b7fc8814d1a7
let
	arr = [x^2  for x in 1:10]
...
# ╔═╡ b69fe938-41d2-49b4-9563-9053b0c6dfad
md"###### Ejemplo 4: for bucles anidaddos"

# ╔═╡ f5108e67-c43e-4260-b51e-a7b4539b4025
let
	for n = 1:5
		for m = 1:5
			println("$n * $m = $(n*m)")
...
# ╔═╡ 1f9f9e33-684a-4351-aed2-b4004234e416
md"###### Ejemplo 5: Bucle externo"

# ╔═╡ eaf64c09-2f62-468f-a0ee-07b54f8896e2
let
	for n = 1:5, m = 1:5
		println("$n * $m = $(n*m)")
	end
...
# ╔═╡ c26c0442-5921-4391-b0b9-358cb80a391d
md"""
### while bucle
Cuando necesitamos hacer un bucle considerando una condición se puede usar `while` 
"""

# ╔═╡ 62f36ab8-7da3-41e9-9b48-9ab6a35723cd
md"""
###### Ejemplo 1: while bucle 
"""

# ╔═╡ 06e8098f-b082-4e08-94d8-1d86be1b698f
let
	a = 10; b = 15;
	while a < b
		println(a)
...
# ╔═╡ 1c3266d5-9664-4012-b901-89136cf8d524
md"###### Ejemplo 2: while bucle usando arreglo"

# ╔═╡ c7583c6a-9113-43d2-9967-cb552b3b31a8
let
	arr = [1,2,3,4];
	while !isempty(arr)
		println(pop!(arr))
...
# ╔═╡ b6900e50-395b-43df-89d0-60f04336669e
md"""
### Break
A veces es conveniente parar un loop cuando una condición es alcanzada. Eso se puede hacer usando `break`
"""

# ╔═╡ c882f86e-be6e-435b-8242-e3de60b5500d
md"###### Ejemplo 1: `break` en while loop"

# ╔═╡ 2ad439e2-c5d8-48c8-b3ce-c48436bf18ad
let
	a = 10; b = 150;
	while a < b
		print(a," ")
...
# ╔═╡ 2803b726-6af7-4f8c-be99-9d92d26a6e88
md"###### Ejemplo 2: `break` en for loop"

# ╔═╡ 8bc23fef-ffbe-4126-843e-124345476a27
let
	arr = rand(1:10,10);
	println(arr)
	searched = 4
...
# ╔═╡ 61fd4d49-a615-47ea-a374-c3e2e8ea5069
md"""
### Continue
Si queremos saltar una (o varias) repeticiones dentro de un loop podemos usar el comando `continue`.
"""

# ╔═╡ 3ced1f4c-7f15-41e5-add9-0f90180ca90c
md"###### Ejemplo 1"

# ╔═╡ 99ef7bc8-4cad-4cf0-bbc0-899ae8171e18
let
	for n in 1:10
		if 3<= n <= 6
			continue
...
# ╔═╡ 0689f654-95d1-4e59-95ef-7a31ec536681
md"""
### Nota: Scope
...
# ╔═╡ 636a500e-0a7e-4ec8-b795-e833d3b5953b
begin
	x = 9;
	function funscope(n)
...
manifest_format = "2.0"
project_hash = "9f728f28d4ca2152a8e2ea17445ebb06ffcefa3b"
