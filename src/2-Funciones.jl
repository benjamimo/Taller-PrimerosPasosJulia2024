...
# ╔═╡ a623a6f4-8f94-11ed-003a-7f4671af49a4
using Markdown, PlutoUI, Images

# ╔═╡ f22e14b4-853f-4926-a9df-bed2534f3b3e
html"<button onclick='present()'>Presentación</button>"

# ╔═╡ 27c2e8d1-4533-4042-ae62-c5093ba23d91

md"""
# Programación en Julia:  Primeros pasos
${\Huge\text{\bf 2. Funciones}}$
...
# ╔═╡ e6a4cd35-c43c-47d1-bf7f-c8ed9f730c54
md"""
...
# ╔═╡ 37b376e1-04f4-4e45-b5ec-c375b20b1b7d
md"""
...
# ╔═╡ 2366e9c8-0197-41e2-a488-5d77e4d1bbe4
md"###### Ejemplo 1: Función sencilla"

# ╔═╡ 1a42fcb6-8936-423e-9259-6de607fb7bdf
function mult(x,y)
...
# ╔═╡ b79224ce-7948-49f5-850b-e43a725a9df7
md"""
###### Nota:
El comando `return` es opcional para este ejemplo ya que tiene sóla operación 
"""

# ╔═╡ 2b291211-3b92-4a42-a92d-faca7caef660
md"###### Ejemplo 2: Condicional"

# ╔═╡ 921aff89-e9da-4a74-a43b-66fb35a18690
let
function mult(x,y)
	println("x es $x, y es $y")
	if x==1
...
# ╔═╡ 28d04943-f5ba-47fd-9f36-90d873edf84c
md"###### Ejemplo 3: Varios valores de salida"

# ╔═╡ ef7f3b6c-a8f6-4b08-900d-38c853bda2cd
let
	function multi(n,m)
		n*m, div(n,n), n%m
	end
...
# ╔═╡ 0f372063-9e8d-4b32-aeb9-43aa5640b14e
let
...
# ╔═╡ 7770eda1-f855-4409-9a56-927a0372f003
md"""
...
# ╔═╡ 478423d2-a114-4f82-b924-c57de0d2bfe4
md"**Nota**: si la función tiene argumentos definidos no aceptará de otro tipo diferente al ya establecido"

# ╔═╡ 86db13e4-d8a9-44b1-9d23-4014229bc102
let
...
# ╔═╡ 06d8da6f-a005-4d4e-9af0-4098b0ee26cd
md"###### Ejemplo 6: Funciones como expresiones matemáticas"

# ╔═╡ 4be4af31-3ad7-4b47-831b-56cc2521f974
let
	f(x,y) = x^3 -x*y + 1/y;
	f(4,5)
end

# ╔═╡ 4be0bd8e-ec40-42b3-8981-6cca0766bf6d
md"""
...
Esta función contiene argumentos opcionales en posición y palabras clave (keyword)
opcionales.
"""

# ╔═╡ bf399ea5-b74e-4c11-a014-c80f2cd51fd2
md"###### Ejemplo 1"

# ╔═╡ 3fe2fa46-8967-47ba-8cea-fa63bfb1b624
let
...
# ╔═╡ c6600157-0632-422c-9e85-787ac00404f0
md"###### Ejemplo 2: Puntos suspensivos"

# ╔═╡ 81a7544e-0455-4759-ad5f-d01cd3d5f6ad
let
	function varargs2(;args...)
		args
	end
...
# ╔═╡ 9279c03b-0b3c-49e7-b7d5-bb2ebb7cb494
md"""
## Funciones anónimas
...
# ╔═╡ 9aa51d02-bb5e-40c6-a2d3-d754b0cccf6d
md"""
...
# ╔═╡ 80dfe5a2-ed2b-4039-b172-46af00459ed6
md"###### Ejemplo 1: Función de función"

# ╔═╡ cea1a5e1-ba91-4634-9e5b-068521a3c4f0
let
...
# ╔═╡ d9db7b89-e5a1-4875-8eab-c5e955367e56
md"###### Ejemplo 2: Funciones anidadas"

# ╔═╡ 68ad13a1-fd78-49ed-8004-ba56c079aaa6
let
	function a(x)
		z = x^2
		function b(z)
...
# ╔═╡ 127974b7-cd15-4ccc-a2b2-4d98986dc55d
md"""
## Broadcasting

Las funciones puedes ser *transmitidas* sobre elementos de un arreglo y hacer operaciones sobre cada uno de ellos. Se usa el operador *punto*:

    f.(arreglo)
"""

# ╔═╡ b011d488-c36f-466a-9ba2-e08de9135a3e
md"###### Ejemplos"

# ╔═╡ 12daa68f-d401-4b71-a88e-c1355cdb9839
let
	function cuad(X)
		cX = X*X
	end
...
# ╔═╡ be62a7a1-38e6-4428-8ca7-cabd9b86ac4f
md"""
## Map y filter
...
# ╔═╡ d0cb38b6-46ff-463b-8e17-3d39f9f6316e
md"###### Ejemplo 1: mapeo de una función sobre vector"

# ╔═╡ 74ee6e98-ca88-44c9-8964-3c636d7d234a
let
map(x-> x*10,[4,5,6])
end

# ╔═╡ b12043a4-e50e-4802-8372-cfe93bd3d085
let
	cubos = map(x->x^3,collect(1:5))
end

# ╔═╡ de8c3a27-f240-4711-a38f-0b3045f3f46d
md"""
...
# ╔═╡ 6396dcef-1453-4f89-abd0-7a924c97a174
let
	map(x -> begin
		if x == 0 return 0
...
# ╔═╡ abe00f31-34c7-47a3-a42b-b30546cf1af5
md""" 
...
# ╔═╡ a6c5ede8-e1cf-4dfc-9d63-66b0c7cffba2
let
...
manifest_format = "2.0"
project_hash = "881408f6999a4baeab15da09fbd258b2b3850293"
